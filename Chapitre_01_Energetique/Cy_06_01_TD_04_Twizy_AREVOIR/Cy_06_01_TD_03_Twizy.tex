...
\ifprof
\begin{corrige}~\\
En faisant l'hypothèse de roulement sans glissement en $I_1$ et $I_2$ on montre que $v = R\omega_{1/0}= R\omega_{2/0}$. De plus, $\omega_{1/0}=r\omega_m$.


On a donc : 
$$4 J_r \dfrac{v}{R}  \dfrac{\dot{v}}{R}  + m v \dot{v} + J_m \dfrac{v}{rR} \dfrac{\dot{v}}{rR} =  -\mu\dfrac{v}{R}  mg\cos \alpha -mvg\sin\alpha +C_m \dfrac{v}{rR} $$

$$ \Leftrightarrow \dot{v}\left(  \dfrac{4 J_r}{R}  + m   +  \dfrac{J_m }{r^2R}\right) +\mu mg\cos \alpha +Rmg\sin\alpha =C_m \dfrac{1}{r} $$
$$ \Leftrightarrow \dot{v}\dfrac{r^2}{R^2}\left(  4 J_r  + m   +  \dfrac{J_m }{r^2}\right) =C_m \dfrac{r}{R}-\dfrac{r^2}{R} mg\left(\mu\cos \alpha +R\sin\alpha\right) $$
