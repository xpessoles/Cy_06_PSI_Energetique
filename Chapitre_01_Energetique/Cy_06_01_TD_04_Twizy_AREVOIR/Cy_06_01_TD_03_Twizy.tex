...
\ifprof
\begin{corrige}~\\
On a isole l'ensemble du véhicule, et on a : 
\begin{itemize}
\item $\ec{E}{0} = \ec{1}{0}+\ec{2}{0}+\ec{3}{0}+\ec{4}{0}$;
\item $\pext{\overline{E}}{E}{0} = \pext{0}{1}{0}+\pext{0}{2}{0}+\pext{\text{pes}}{E}{0}$;
\item $\mathcal{P}_{\text{int}}=\pint{1}{3}+\pint{3}{2}+\pint{3}{4}+\pint{2}{4}$ car les liaisons à l'intérieur de l'isolement sont parfaites.
\end{itemize}
\end{corrige}
