%%%% Paramétrage du TD %%%%
\def\xxactivite{ \ifprof \normalsize{Activation 2 -- Corrigé } \else  \ifcolle Colle \else Activation 2\fi \fi} % \normalsize \vspace{-.4cm}
...
\subparagraph{}\textit{Déterminer l’énergie cinétique galiléenne, notée $E_{c_T}$, des 4 brins de câble, de l’ensemble
...
\subparagraph{}\textit{Déterminer la puissance galiléenne, notée $P_p$, des actions de pesanteur sur l’installation en
...
\subparagraph{}\textit{Après avoir évalué la vitesse relative et l’action du vent sur une cabine en montée et une
...
$ = 8 \torseurl{-pS_f\vect{i}}{\vect{0}}{G_c} \otimes \torseurl{\vect{0}}{V\vect{i}}{G_c}	$
$ = -8S_fV\dfrac{1}{2}\rho \left(V+V_e\right)^2 $.
...
Au final, $\pext{\text{vent}}{C_m+C_d}{0} =8S_fV\dfrac{1}{2}\rho \left(\left(V-V_e\right)^2- \left(V+V_e\right)^2\right)$ $=8S_fV\dfrac{1}{2}\rho\left( -4VV_e\right)$
$=-16S_f \rho V^2 V_e$. Au final, 
%$ = -8\left(M_c+M_p\right)gV\vect{z} \cdot \vect{i}$
%$ = -8\left(M_c+M_p\right)gV \sin \alpha$.
$\pext{\text{vent}}{C_m+C_d}{0} = \SI{-229672}{W} $
\end{corrige}\else\fi


\subparagraph{}\textit{En déduire une estimation de la puissance galiléenne nécessaire, notée $P_T$ pour
...
$0 = -229672-359289-400 000 +P_T $ $ P_T= 229672 + 359289 + 400 000 = \SI{988960}{W} \simeq \SI{1000}{kW}$.
...
\subparagraph{}\textit{Quelle est alors la durée $t$ de la phase d’accélération ? Exprimer la longueur $x$ (en mètre)
